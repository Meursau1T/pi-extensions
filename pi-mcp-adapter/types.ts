...
export interface McpSettings {
  ...
  elicitation?: boolean;
  /** Per-server Pi overrides. False disables a server without changing its shared definition. */
...
export function isServerEnabled(config: McpConfig, serverName: string): boolean {
  return config.settings?.serverStates?.[serverName] !== false;
}
